...
#define REG_LR_CAD_PNR                              (0x34)      //PeakNoiseRatio
#define REG_LR_CAD_PEAK_MIN                         (0x35)
...
#define RFLR_OPMODE_FSTX                            (0x02)
#define RFLR_OPMODE_TX                              (0x03)
#define RFLR_OPMODE_FSRX        	                (0x04)
#define RFLR_OPMODE_RX                              (0x05)
#define RFLR_OPMODE_RXCONTINUOUS                    (0x05)
// LoRa specific modes
#define RFLR_OPMODE_RXSINGLE                        (0x06)
...
#define RFLR_INVERTIQ_CRX_MASK                       0xFD
#define RFLR_INVERTIQ_CRX_OFF                        0x02
#define RFLR_INVERTIQ_CRX_ON                         0x00
...
#define RFLR_DIOMAPPING1_DIO0_RX_DONE				(0x00)
#define RFLR_DIOMAPPING1_DIO0_01                    (0x40)
#define RFLR_DIOMAPPING1_DIO0_TX_DONE               (0x40)
#define RFLR_DIOMAPPING1_DIO0_10                    (0x80)
#define RFLR_DIOMAPPING1_DIO0_CAD_DONE              (0x80)
#define RFLR_DIOMAPPING1_DIO0_11                    (0xC0)

#define RFLR_DIOMAPPING1_DIO1_MASK                  (0xCF)
#define RFLR_DIOMAPPING1_DIO1_00                    (0x00)  // Default
#define RFLR_DIOMAPPING1_DIO1_RX_TIMEOUT            (0x00)
#define RFLR_DIOMAPPING1_DIO1_01                    (0x10)
#define RFLR_DIOMAPPING1_DIO1_FHSS_CHANGE_CHANNEL	(0x10)
#define RFLR_DIOMAPPING1_DIO1_10                    (0x20)
#define RFLR_DIOMAPPING1_DIO0_CAD_DETECTED          (0x20)
